...
class Cell:
    ...
    def __init__(self, cell):
        if cell is not None:
            self.cellVal = cell.cellVal
            self.perm = [i for i in cell.perm]
            self.sum = [i for i in cell.sum]
...
class Board:
    ...
    def __init__(self, board):
        if board is not None:
            self.rowPerm = [Cell(i) for i in board.rowPerm]
            self.colPerm = [Cell(i) for i in board.colPerm]
